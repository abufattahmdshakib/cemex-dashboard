...
// Columns to display in table (exclude Avg. Growth)
const tableColumns = allColumns.filter(col => col.key !== "growth");

const ProfitMargin = () => {
    const [selectedCity, setSelectedCity] = useState("All");
    const [dropdownOpen, setDropdownOpen] = useState(false);
    const [checkboxes, setCheckboxes] = useState(allColumns.map(col => true)); // visual toggle only
        ...
        <div className="font-montserrat-fontsfamily">
            ...
            <div className="flex justify-between items-center mt-12 mb-6">
                ...
                <div className="relative" ref={dropdownRef}>
                    ...
                    {dropdownOpen && (
                        <div className="absolute right-0 mt-2 w-56 bg-white border border-[#DBE0E5] rounded-[12px] p-4 shadow-lg z-10">
