...
const revenueData = [
    { segment: "High Value", revenue: 16709000, avgOrderValue: 16709000, orderFrequency: 10, customer: 100, lifetimeValue: 97320, city: "Dhaka" },
    { segment: "At Risk", revenue: 6345000, avgOrderValue: 6345000, orderFrequency: 8, customer: 79, lifetimeValue: 45000, city: "Sylhet" },
    { segment: "New", revenue: 9597320, avgOrderValue: 9597320, orderFrequency: 5, customer: 50, lifetimeValue: 6000597, city: "Chattogram" },
    { segment: "Low Value", revenue: 6000597, avgOrderValue: 6000597, orderFrequency: 7, customer: 80, lifetimeValue: 550000, city: "Barisal" },
    { segment: "Potential", revenue: 4500000, avgOrderValue: 4500000, orderFrequency: 6, customer: 63, lifetimeValue: 950000, city: "Dhaka" },
];
...
const RevenueShare = () => {
    ...
    const filteredData = selectedCity === "All"
        ? revenueData
        : revenueData.filter(row => row.city === selectedCity);
        ...
        <div className="montserrat-fontsfamily">
            ...
            <div className="flex justify-between items-center mt-12 mb-6">
                ...
                <div className="relative cursor-pointer" ref={dropdownRef}>
                    ...
                    {dropdownOpen && (
                        <div className="absolute right-0 mt-2 w-62 bg-white border border-[#DBE0E5] rounded-[12px] p-4 shadow-lg z-10 cursor-pointer">
            ...
            <div className="bg-white shadow-md rounded-[12px] border border-[#E5E8EB] overflow-x-auto">
                {filteredData.length === 0 ? (
                    <div className="text-center py-10 text-[#121417] font-[500] text-[16px] cursor-pointer">
                    ...
                    <table className="w-full border-collapse cursor-pointer">
                            ...
                            <tr className="bg-white text-left">
                                {tableColumns.map((col, index) =>
                                    checkboxes[index] && (
                                        <th
                                            key={col.key}
                                            className="px-4 py-3 border-b border-[#E5E8EB] text-[#121417] text-[14px] font-[600] cursor-pointer"
                                        >
                                            {col.label}
                                        </th>
                                    )
                        ...
                        <tbody>
                            {filteredData.map((row) => (
                                <tr key={row.segment} className="hover:bg-gray-50 cursor-pointer">
                                    {tableColumns.map((col, index) =>
                                        checkboxes[index] && (
                                            <td
                                                key={col.key}
